...
tk.configure(background="#2F2D30", padx=1, pady=1)

frame_main = Frame(tk, borderwidth=2, relief="sunke", background="#2F2D30")
frame_main.place(x=3, y=3,height=460, width=772)

photo_main = PhotoImage(file='img_main.png')
label_photo = Label(tk, bg="#2F2D30", image=photo_main, compound='bottom')
label_photo.place(x=4, y=4)

ft = font.Font(family="Ink Free", size=10, weight="normal", slant="italic")

menu_bar = Menu(tk)
menu_main = Menu(menu_bar, tearoff=False, background="#2F2D30", activebackground="#2F2D30", font=ft, fg="#ffffff", activeforeground="#ff7f50")
...
menu_2 = Menu(menu_bar, tearoff=False, background="#2F2D30", activebackground="#2F2D30", font=ft, fg="#ffffff", activeforeground="#ff7f50")
...
menu_3 = Menu(menu_bar, tearoff=False, background="#2F2D30", activebackground="#2F2D30", font=ft, fg="#ffffff", activeforeground="#ff7f50")
...
menu_4 = Menu(menu_bar, tearoff=False, background="#2F2D30", activebackground="#2F2D30", font=ft, fg="#ffffff", activeforeground="#ff7f50")
...
menu_5 = Menu(menu_bar, tearoff=False, background="#2F2D30", activebackground="#2F2D30", font=ft, fg="#ffffff", activeforeground="#ff7f50")
...
menu_6 = Menu(menu_bar, tearoff=False, background="#2F2D30", activebackground="#2F2D30", font=ft, fg="#ffffff", activeforeground="#ff7f50")
